...
class Database {
    ...
    get pages() {
        return {
            get: (identifer, excludeProperties) => page_1.default.get(__classPrivateFieldGet(this, _Database_properties, "f"), identifer, excludeProperties),
            getMany: (options) => page_1.default.getMany(__classPrivateFieldGet(this, _Database_id, "f"), __classPrivateFieldGet(this, _Database_properties, "f"), options),
