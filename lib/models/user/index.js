...
class User {
    ...
    get object() {
        return {
            id: __classPrivateFieldGet(this, _User_id, "f"),
            name: __classPrivateFieldGet(this, _User_name, "f"),
    ...
    static getAll() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                ...
                users.push(...results.map((result) => {
                    var _a;
                    return result.type === 'person'
                        ? new User(result.id, result.name, result.avatar_url, (_a = result.person) === null || _a === void 0 ? void 0 : _a.email)
