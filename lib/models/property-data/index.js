...
var _Title_value, _RichText_value, _Number_value, _Select_value, _MultiSelect_values, _Date_start, _Date_options, _Checkbox_value, _URL_value, _Email_value, _PhoneNumber_value, _People_value;
...
class People {
    constructor(value) {
        _People_value.set(this, void 0);
        __classPrivateFieldSet(this, _People_value, value, "f");
    }
    get notionValue() {
        return {
            // TODO: implement writing person into database
            people: __classPrivateFieldGet(this, _People_value, "f"),
        };
    }
    static getValue(notionValue) {
        return notionValue.people.map((person) => {
            ...
            const data = {
                id: person.id,
                name: (_a = person.name) !== null && _a !== void 0 ? _a : '',
                avatar: (_b = person.avatar_url) !== null && _b !== void 0 ? _b : '',
            };
            if (person.person) {
