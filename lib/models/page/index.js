...
var _Page_id, _Page_url, _Page_notionProperties, _Page_properties, _Page_archived;
Object.defineProperty(exports, "__esModule", { value: true });
const api_1 = __importStar(require("../../utils/api"));
const notion_1 = require("../../utils/notion");
class Page {
    constructor(id, url, notionProperties, properties, archived) {
    ...
    static get(notionProperties, identifer, excludeProperties) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            do {
                try {
                    ...
                    page = new Page(pageResponse.id, pageResponse.url, notionProperties, properties, pageResponse.archived);
                }
                catch (error) {
            ...
            do {
                ...
                try {
                    ...
                    const pageProperties = results.map((pageResponse) => {
                        ...
                        const page = new Page(pageResponse.id, pageResponse.url, notionProperties, properties, pageResponse.archived);
    ...
    update(data) {
        return __awaiter(this, void 0, void 0, function* () {
            let retries = 0;
            const propertyNames = Object.keys(data);
            const { valid, errors } = notion_1.validatePropertiesExist(propertyNames, __classPrivateFieldGet(this, _Page_notionProperties, "f"));
            if (!valid) {
                throw new Error(errors.join(', '));
            }
            let page = null;
            do {
                try {
                    const response = yield api_1.default.patch(`/pages/${__classPrivateFieldGet(this, _Page_id, "f")}`, {
                        properties: notion_1.transformToNotionProperties(__classPrivateFieldGet(this, _Page_notionProperties, "f"), data),
                    });
                    const pageResponse = response.data;
                    const properties = Object.entries(pageResponse.properties).reduce((prevProperties, [propertyName, value]) => {
                        return Object.assign(Object.assign({}, prevProperties), { [propertyName]: notion_1.transformFromNotionProperties(value) });
                    }, {});
                    page = new Page(pageResponse.id, pageResponse.url, __classPrivateFieldGet(this, _Page_notionProperties, "f"), properties, pageResponse.archived);
                }
                catch (error) {
                    if (!error.isAxiosError) {
                        throw new Error(error);
            ...
            if (!page) {
                throw new Error(`Page ${__classPrivateFieldGet(this, _Page_id, "f")} failed to update.`);
            }
            return page;
        });
    }
    restore() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield setArchived(__classPrivateFieldGet(this, _Page_id, "f"), __classPrivateFieldGet(this, _Page_notionProperties, "f"), false);
        });
    }
    delete() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield setArchived(__classPrivateFieldGet(this, _Page_id, "f"), __classPrivateFieldGet(this, _Page_notionProperties, "f"), true);
        });
    }
}
_Page_id = new WeakMap(), _Page_url = new WeakMap(), _Page_notionProperties = new WeakMap(), _Page_properties = new WeakMap(), _Page_archived = new WeakMap();
exports.default = Page;
function setArchived(pageId, notionProperties, archived) {
    return __awaiter(this, void 0, void 0, function* () {
        let retries = 0;
        let page = null;
        do {
