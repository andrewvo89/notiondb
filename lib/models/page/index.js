...
class Page {
            ...
            do {
                try {
                    ...
                    const properties = Object.entries(pageResponse.properties).reduce((prevProperties, [propertyName, value]) => {
                        ...
                        return Object.assign(Object.assign({}, prevProperties), { [propertyName]: transformFromNotionProperties(value) });
                    }, {});
    ...
    static getMany(databaseId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            let hasMore = false;
            let nextCursor = '';
            const pages = [];
            do {
                ...
                try {
                    ...
                    const response = yield api_1.default.post(`/databases/${databaseId}/query${nextCursorParam}`, requestOptions);
